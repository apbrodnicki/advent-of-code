...
read.on('line', function (line) {
	...
	if (
		(secondSectionFirstNumber >= firstSectionFirstNumber &&
			secondSectionFirstNumber <= firstSectionLastNumber) ||
		(secondSectionLastNumber >= firstSectionFirstNumber &&
			secondSectionLastNumber <= firstSectionLastNumber) ||
		(firstSectionFirstNumber >= secondSectionFirstNumber &&
			firstSectionFirstNumber <= secondSectionLastNumber) ||
		(firstSectionLastNumber >= secondSectionFirstNumber &&
